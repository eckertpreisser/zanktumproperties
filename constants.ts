...
const VILLA_CONTENT: Record<Language, { alpha: { tagline: string; description: string; amenities: string[] }; beta: { tagline: string; description: string; amenities: string[] } }> = {
  en: {
    ...
    beta: {
      ...
      description: 'A paradise mirrored in every detail. Enjoy world-class finishes, a private pool, and Mediterranean vistas from a unique perspective.',
      amenities: ['Private Pool', 'Smart Home', 'Panorama Terrace', 'Modern Kitchen', 'Dressing Room', 'Rooftop Lounge'],
    },
  },
  de: {
    ...
    beta: {
      ...
      description: 'Ein Paradies, gespiegelt bis ins letzte Detail. Geniessen Sie erstklassige Ausstattungen, den privaten Pool und den Mittelmeerblick aus einer einzigartigen Perspektive.',
      amenities: ['Privater Pool', 'Smart Home', 'Panorama-Terrasse', 'Moderne Kueche', 'Ankleideraum', 'Dachlounge'],
    },
  },
  ar: {
    ...
    beta: {
      ...
      description: 'فردوس ينعكس في كل التفاصيل. استمتع بتشطيبات عالمية المستوى ومسبح خاص وإطلالات متوسطية من منظور فريد.',
      amenities: ['مسبح خاص', 'منزل ذكي', 'تراس بانورامي', 'مطبخ حديث', 'غرفة ملابس', 'صالة على السطح'],
    },
  },
  ru: {
    ...
    beta: {
      ...
      description: 'Рай, отражённый в каждой детали. Наслаждайтесь отделкой мирового класса, частным бассейном и средиземноморскими видами с уникальной перспективы.',
      amenities: ['Частный бассейн', 'Умный дом', 'Панорамная терраса', 'Современная кухня', 'Гардеробная', 'Лаунж на крыше'],
    },
  },
  uk: {
    ...
    beta: {
      ...
      description: 'Рай, відображений у кожній деталі. Насолоджуйтеся оздобленнями світового класу, приватним басейном і середземноморськими видами з унікальної перспективи.',
      amenities: ['Приватний басейн', 'Розумний будинок', 'Панорамна тераса', 'Сучасна кухня', 'Гардеробна', 'Лаунж на даху'],
    },
  },
  zh: {
    ...
    beta: {
      tagline: '您的天堂镜像',
      description: '天堂在每一处细节中呈现。尽享世界级精装修、私人泳池和独特视角下的地中海美景。',
      amenities: ['私人泳池', '智能家居', '全景露台', '现代厨房', '更衣室', '屋顶休闲区'],
    },
  },
  es: {
    ...
    beta: {
      ...
      description: 'Un paraíso reflejado en cada detalle. Disfruta de acabados de clase mundial, piscina privada y vistas mediterráneas desde una perspectiva única.',
      amenities: ['Piscina Privada', 'Casa Inteligente', 'Terraza Panorámica', 'Cocina Moderna', 'Vestidor', 'Lounge en Azotea'],
    },
  },
  fr: {
    ...
    beta: {
      ...
      description: 'Un paradis reflété dans chaque détail. Profitez de finitions de classe mondiale, d\'une piscine privée et de vues méditerranéennes depuis une perspective unique.',
      amenities: ['Piscine Privée', 'Maison Connectée', 'Terrasse Panoramique', 'Cuisine Moderne', 'Dressing', 'Lounge en Toiture'],
    },
  },
  tr: {
    ...
    beta: {
      ...
      description: 'Her ayrıntıda yansıyan bir cennet. Dünya standardındaki işçiliğin, özel havuzun ve Akdeniz manzarasının keyfini benzersiz bir perspektiften çıkarın.',
      amenities: ['Özel Havuz', 'Akıllı Ev', 'Panoramik Teras', 'Modern Mutfak', 'Giyinme Odası', 'Çatı Lounge'],
    },
  },
};
...
const buildVillas = (lang: Language): Villa[] => [
  // KALONOROS-Brandmauer (2026-06-27): Villa Alpha (Flaggschiff) entfernt — nur noch Villa Beta.
  {
    id: 'villa-b', name: 'ZANKTUM Villa',
    ...
    // 2/3/5/14 entfernt: zeigen die inzwischen aus dem Angebot genommene zweite Villa (Z-Cleopatra-Skulptur bzw. Nachbargebäude im Bild)
    // 13 entfernt (2026-08-25): zeigt im Hintergrund ebenfalls das zweite Gebäude/Villa
    exteriorImages: [`${IMG}/exterior/1.png?v=2`, `${IMG}/exterior/4.png?v=2`, `${IMG}/exterior/6.png?v=2`, `${IMG}/exterior/7.png?v=2`, `${IMG}/exterior/8.png?v=2`, `${IMG}/exterior/9.png?v=2`, `${IMG}/exterior/10.png?v=2`, `${IMG}/exterior/11.png?v=2`, `${IMG}/exterior/12.png?v=2`],
...
const TRANSLATIONS: Record<Language, {
  ...
  en: {
    ...
    hero: { subtitle: 'Exclusive Luxury Villa Collection', titleMain: 'Zanktum', titleSub: 'Villa', description: 'A private sanctuary. 250 metres above the everyday. Where history whispers from the castle. Where the sea breathes below. Where you belong.', discover: 'Discover' },
    showcase: { subtitle: 'Your Villa at the Zanktum', title: 'A Masterpiece. Unrepeatable.', bedrooms: 'Bedrooms', bathrooms: 'Bathrooms', details: 'Explore Villa' },
    explorer: { subtitle: 'Interactive Experience', title: 'Explore The Villa', description: 'Discover every detail of our luxury villa from the outside in.', exterior: 'Exterior', interior: 'Interior', selectFloor: 'Click to explore', backToOverview: 'Back to Overview', backToFloor: 'Back to Floor Plan', basement: 'Basement', groundFloor: 'Ground Floor', firstFloor: 'First Floor', attic: 'Attic', view3D: '3D View', floorPlan: 'Floor Plan' },
    ...
    footer: { desc: 'An exclusive villa at 250m above Alanya. A total work of art of architecture, master craftsmanship and world-class artistry.', contact: 'Contact', follow: 'Follow', rights: '\u00a9 2026 ZANKTUM Villa Alanya. All Rights Reserved.' },
  },
  de: {
    nav: { collection: 'Kollektion', explore: 'Erkunden', concierge: 'Concierge', contact: 'Kontakt' },
    hero: { subtitle: 'Exklusive Luxusvilla-Kollektion', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Eine private Zuflucht. 250 Meter über der alltäglichen Welt. Wo Geschichte aus der Burg flüstert. Wo das Meer unter Ihnen atmet. Wo Sie hingehören.', discover: 'Villa Entdecken' },
    showcase: { subtitle: 'Ihre Villa im Zanktum', title: 'Ein Meisterwerk. Unwiederholbar.', bedrooms: 'Schlafzimmer', bathrooms: 'Badezimmer', details: 'Villa Erkunden' },
    explorer: { subtitle: 'Interaktives Erlebnis', title: 'Die Villa Erkunden', description: 'Entdecken Sie jedes Detail unserer Luxus-Villa von aussen nach innen.', exterior: 'Exterieur', interior: 'Interieur', selectFloor: 'Klicken zum Erkunden', backToOverview: 'Zurueck zur Uebersicht', backToFloor: 'Zurueck zum Grundriss', basement: 'Untergeschoss', groundFloor: 'Erdgeschoss', firstFloor: 'Obergeschoss', attic: 'Dachgeschoss', view3D: '3D-Ansicht', floorPlan: 'Grundriss' },
    ...
    footer: { desc: 'Eine exklusive Villa, 250m \u00fcber Alanya. Ein Gesamtkunstwerk aus Architektur, meisterhafter Bauausf\u00fchrung und weltbekannter K\u00fcnstlerschaft.', contact: 'Kontakt', follow: 'Folgen', rights: '\u00a9 2026 ZANKTUM Villa Alanya. Alle Rechte vorbehalten.' },
  },
  ar: {
    nav: { collection: 'المجموعة', explore: 'استكشاف', concierge: 'الكونسيرج', contact: 'اتصل بنا' },
    hero: { subtitle: 'مجموعة فيلات فاخرة حصرية', titleMain: 'Zanktum', titleSub: 'Villa', description: 'ملاذ خاص. 250 متراً فوق العالم اليومي. حيث تهمس الحكايات من القلعة. حيث يتنفس البحر تحتك. حيث تنتمي.', discover: 'اكتشف الفيلات' },
    showcase: { subtitle: 'فيلتك في زانكتم', title: 'تحفة فنية لا تتكرر', bedrooms: 'غرف النوم', bathrooms: 'الحمامات', details: 'استكشف الفيلا' },
    ...
    footer: { desc: 'فيلتان حصريتان على ارتفاع 250 متراً فوق ألانيا. تحفة شاملة من العمارة والحرفية وفن الفنانين العالميين.', contact: 'اتصل بنا', follow: 'تابعنا', rights: '\u00a9 2026 ZANKTUM Villa Alanya. جميع الحقوق محفوظة.' },
  },
  ru: {
    nav: { collection: 'Коллекция', explore: 'Исследовать', concierge: 'Консьерж', contact: 'Контакт' },
    hero: { subtitle: 'Эксклюзивная коллекция люкс-вилл', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Частное убежище. На 250 метров над повседневным миром. Где история шепчет из крепости. Где море дышит под вами. Где ваше место.', discover: 'Открыть виллы' },
    showcase: { subtitle: 'Ваша вилла в Zanktum', title: 'Шедевр. Неповторим.', bedrooms: 'Спальни', bathrooms: 'Ванные', details: 'Изучить виллу' },
    ...
    footer: { desc: 'Две эксклюзивные виллы на высоте 250м над Аланией. Целостное произведение архитектуры, мастерства и мирового искусства.', contact: 'Контакт', follow: 'Подписаться', rights: '\u00a9 2026 ZANKTUM Villa Alanya. Все права защищены.' },
  },
  uk: {
    nav: { collection: 'Колекція', explore: 'Дослідити', concierge: 'Консьєрж', contact: 'Контакт' },
    hero: { subtitle: 'Ексклюзивна колекція люкс-вілл', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Приватний прихисток. На 250 метрів над повсякденним світом. Де історія шепоче з фортеці. Де море дихає під вами. Де ваше місце.', discover: 'Дослідити вілли' },
    showcase: { subtitle: 'Ваша вілла в Zanktum', title: 'Шедевр. Неповторний.', bedrooms: 'Спальні', bathrooms: 'Ванні', details: 'Дослідити віллу' },
    ...
    footer: { desc: 'Дві ексклюзивні вілли на висоті 250м над Аланією. Цілісний витвір архітектури, майстерності та світового мистецтва.', contact: 'Контакт', follow: 'Підписатись', rights: '\u00a9 2026 ZANKTUM Villa Alanya. Всі права захищені.' },
  },
  zh: {
    nav: { collection: '系列', explore: '探索', concierge: '礼宾', contact: '联系' },
    hero: { subtitle: '专属奢华别墅系列', titleMain: 'Zanktum', titleSub: 'Villa', description: '私人庇护所。在日常世界之上250米。古堡低语历史。脚下大海呼吸。这是您的归属。', discover: '探索别墅' },
    showcase: { subtitle: 'Zanktum的别墅', title: '一件杰作，独一无二', bedrooms: '卧室', bathrooms: '浴室', details: '探索别墅' },
    ...
    footer: { desc: '两栋专属别墅，矗立于阿拉尼亚之上250米。融合建筑、精湛工艺与世界级艺术的完整作品。', contact: '联系', follow: '关注', rights: '\u00a9 2026 ZANKTUM Villa Alanya. 版权所有。' },
  },
  es: {
    nav: { collection: 'Colección', explore: 'Explorar', concierge: 'Conserjería', contact: 'Contacto' },
    hero: { subtitle: 'Colección Exclusiva de Villas de Lujo', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Un refugio privado. 250 metros sobre el mundo cotidiano. Donde la historia susurra desde el castillo. Donde el mar respira bajo usted. Donde usted pertenece.', discover: 'Descubrir Villas' },
    showcase: { subtitle: 'Su Villa en el Zanktum', title: 'Una Obra Maestra. Irrepetible.', bedrooms: 'Dormitorios', bathrooms: 'Baños', details: 'Explorar Villa' },
    ...
    footer: { desc: 'Dos villas exclusivas a 250m sobre Alanya. Una obra integral de arquitectura, maestría artesanal y arte de renombre mundial.', contact: 'Contacto', follow: 'Seguir', rights: '\u00a9 2026 ZANKTUM Villa Alanya. Todos los derechos reservados.' },
  },
  fr: {
    nav: { collection: 'Collection', explore: 'Explorer', concierge: 'Conciergerie', contact: 'Contact' },
    hero: { subtitle: 'Collection Exclusive de Villas de Luxe', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Un refuge privé. À 250 mètres au-dessus du monde quotidien. Où l\'histoire chuchote depuis le château. Où la mer respire sous vous. Où vous appartenez.', discover: 'Découvrir les Villas' },
    showcase: { subtitle: 'Votre Villa au Zanktum', title: 'Un Chef-d\'Œuvre. Inégalable.', bedrooms: 'Chambres', bathrooms: 'Salles de bain', details: 'Explorer la Villa' },
    ...
    footer: { desc: 'Deux villas exclusives à 250m au-dessus d\'Alanya. Une œuvre totale d\'architecture, de savoir-faire et d\'art de renommée mondiale.', contact: 'Contact', follow: 'Suivre', rights: '\u00a9 2026 ZANKTUM Villa Alanya. Tous droits réservés.' },
  },
  tr: {
    nav: { collection: 'Koleksiyon', explore: 'Keşfet', concierge: 'Konsiyerj', contact: 'İletişim' },
    hero: { subtitle: 'Özel Lüks Villa Koleksiyonu', titleMain: 'Zanktum', titleSub: 'Villa', description: 'Özel bir sığınak. Gündelik dünyanın 250 metre üzerinde. Tarihin kaleden fısıldadığı yer. Denizin altınızda nefes aldığı yer. Ait olduğunuz yer.', discover: 'Villaları Keşfet' },
    showcase: { subtitle: 'Zanktum\'daki Villanız', title: 'Bir Başyapıt. Eşsiz.', bedrooms: 'Yatak Odası', bathrooms: 'Banyo', details: 'Villayı Keşfet' },
    ...
    footer: { desc: 'Alanya\'nın 250 m üzerinde iki özel villa. Mimari, usta işçilik ve dünyaca ünlü sanatın bütünsel bir başyapıtı.', contact: 'İletişim', follow: 'Takip Et', rights: '© 2026 ZANKTUM Villa Alanya. Tüm Hakları Saklıdır.' },
  },
};
...
export const getNavLinks = (lang: Language) => {
  ...
  return [
    ...
    // KALONOROS-Brandmauer (2026-06-27): Artist + Sculpture aus dem Header entfernt (gehören zu KALONOROS).
